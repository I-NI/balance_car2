...
typedef struct {
    ...
    int16_t right_direction ;
	  ...
	  int16_t left_capture_first ;
	  int16_t right_capture_first ;
	
	  int16_t left_phase_diff ;
	  int16_t left_half_period ;
	  int16_t right_phase_diff ;
	  int16_t right_half_period ;
    int32_t left_start_val[ 2 ] ;
	  int32_t left_end_val[ 2 ]   ;
    int32_t right_start_val[ 2 ] ;
	  int32_t right_end_val[ 2 ]  ;
